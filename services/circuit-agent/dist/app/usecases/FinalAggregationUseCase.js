...
export class FinalAggregationUseCase {
    ...
    async execute(params) {
        ...
        const fullRequest = { model: params.model, system: params.systemPrompt || '', messages: [{ role: 'user', content: userPrompt }], apiUrl: params.apiUrl, headers };
        ...
        const done = this.timeline.make('llm.response', { model: params.model, tag: 'final_aggregate', snippet: String(resp.text || '').slice(0, 1000) });
