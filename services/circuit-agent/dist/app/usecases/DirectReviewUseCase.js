...
export class DirectReviewUseCase {
    ...
    async execute(params) {
        ...
        const hasHistory = (() => { try {
            return Array.isArray(params.request.history) && params.request.history.length > 0;
        }
        catch {
            return false;
        } })();
        ...
        tlReq.artifacts = Object.assign({}, tlReq.artifacts || {}, { request: reqArtifact });
        ...
        tlResp.artifacts = Object.assign({}, tlResp.artifacts || {}, { response: respArtifact, result: reportA });
