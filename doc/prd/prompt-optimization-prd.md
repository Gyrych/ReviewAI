...
2. **单/多 agent 提示词未隔离**：所有提示词文件混放在 `ReviewAIPrompt/` 根目录，职责不清晰
...
```
ReviewAIPrompt/
├── circuit-agent/                        # 单 agent 模式
│   ├── system_prompt_initial_zh.md       # 首轮 - 中文
│   ├── system_prompt_initial_en.md       # 首轮 - 英文
│   ├── system_prompt_revision_zh.md      # 修订轮 - 中文
│   └── system_prompt_revision_en.md      # 修订轮 - 英文
├── circuit-fine-agent/                   # 多 agent 模式
│   ├── system_prompt_zh.md               # 系统级 - 中文
│   ├── system_prompt_en.md               # 系统级 - 英文
...
- [ ] PRD 内容审批通过
- [ ] 单 agent 首轮提示词（中文）审批通过
- [ ] 单 agent 首轮提示词（英文）审批通过，与中文语义等效
- [ ] 单 agent 修订轮提示词（中文）审批通过
- [ ] 单 agent 修订轮提示词（英文）审批通过，与中文语义等效
- [ ] 多 agent 系统提示词（中文）审批通过
- [ ] 多 agent 系统提示词（英文）审批通过，与中文语义等效
- [ ] 代码改造审批通过
- [ ] 测试验证通过（7.1-7.10）
- [ ] 文档更新审批通过
