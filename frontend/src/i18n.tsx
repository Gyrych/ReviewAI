...
const dictZh: Record<string, string> = {
  ...
  'app.tabs.circuit_single': '电路图评审（主副模型架构）',
  'app.tabs.circuit_multi': '电路图评审（委员会架构）',
  'app.tabs.code': '代码评审',
  'app.tabs.doc': '文档评审',
  'app.tabs.req': '需求评审',
  'app.tab.todo': '（待开发）',
...
const dictEn: Record<string, string> = {
  ...
  'app.tabs.circuit_single': 'Circuit Review (Main-Aux Model Architecture)',
  'app.tabs.circuit_multi': 'Circuit Review (Committee Architecture)',
